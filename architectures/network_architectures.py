...
def resnet101_deeplab_coco(num_classes=21, pretrained=True, doublehead=False, mocoin=0): # doublehead
    return deeplab2.resnet101_deeplab_coco(num_classes=num_classes, pretrained=pretrained, doublehead=doublehead, mocoin=mocoin)

@seg.register('resnet101_deeplab_imagenet')
def resnet101_deeplab_imagenet(num_classes=21, pretrained=True, doublehead=False, mocoin=0): # double head since 08 Nov
    return deeplab2.resnet101_deeplab_imagenet(num_classes=num_classes, pretrained=pretrained, doublehead=doublehead, mocoin=mocoin)
